...
function ModalPhotoWorker({ id, photo, children }) {
  ...
  let hendelSubmit = (e) => {
    ...
    axios
      .put(`https://be-hirejob.vercel.app/work/photo/${id}`, formData)
      .then((res) => {
        console.log(res);
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>{children} Worker</Modal.Title>
        </Modal.Header>
...
export default ModalPhotoWorker;
